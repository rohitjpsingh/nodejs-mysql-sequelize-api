...
constant.license = [
  { name: "trial", amt: 0 },
  { name: "trial-expired", amt: 0 },
  // {name:"30-days",amt:7080},
  { name: "30-days", amt: 990 },
  { name: "90-days", amt: 0 },
  // {name:"365-days",amt:5900},
  { name: "365-days", amt: 9900 },
  { name: "developer", amt: 0 },
  { name: "sales", amt: 0 },
  { name: "educational", amt: 0 },
  { name: "other", amt: 0 },
  { name: "cancelled", amt: 0 },
  { name: "cancelled-expired", amt: 0 },
  { name: "unlimited", amt: 0 },
];
constant.licenseRole = ["creator", "viewer"];
constant.userLanguages = [
  { code: "DK", name: "da-DK" },
  { code: "NL", name: "nl-NL" },
  { code: "BE", name: "nl-BE" },
  { code: "GB", name: "en-GB" },
